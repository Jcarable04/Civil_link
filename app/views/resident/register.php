...
/* Glowing circular shape behind the card */
.card::before {
    content: '';
    position: absolute;
    width: 300px;
...
<div class="card">
    <h3>Register</h3>
    <div class="welcome-message">Welcome to <strong>Civil_Link</strong>. Please create your account.</div>
    ...
    <p class="text-center">
        Already have an account? <a href="/resident/login">Login</a>
    </p>
</div>
